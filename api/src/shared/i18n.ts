...
const BOT_STRINGS: Record<SupportedLanguage, Record<BotKey, string>> = {
  en: {
    ...
    "setup.alreadySetUp": "This group is already set up. The launch message is pinned above.",
    "setup.error": "Setup failed. Please try again.",
  },
  es: {
    "setup.notAdmin": "Solo los administradores del grupo pueden ejecutar /setup.",
    "setup.notGroup": "/setup debe ejecutarse dentro de un grupo.",
    "setup.botMissingPinRight":
      "Concédeme permiso para fijar mensajes y vuelve a ejecutar /setup.",
    "setup.success": "Grupo registrado. El mensaje de inicio está fijado arriba.",
    "setup.alreadySetUp": "Este grupo ya está configurado. El mensaje de inicio está fijado arriba.",
  ...
  ru: {
    ...
    "setup.success": "Группа зарегистрирована. Сообщение запуска закреплено выше.",
    "setup.alreadySetUp": "Эта группа уже настроена. Сообщение запуска закреплено выше.",
